...
let today = __WEBPACK_IMPORTED_MODULE_0_moment___default()().format('YYYY-MM-DD HH:mm:ss')
let preWeek = __WEBPACK_IMPORTED_MODULE_1_moment_recur___default()().recur().every(1).days(7)
console.log('%c today', 'color:green', today, '\n')
console.log('%c preWeek', 'color:dodgerblue', ...preWeek, '\n')
console.log('%c useMomentRecur', 'color:red', ...__WEBPACK_IMPORTED_MODULE_2__useMomentRecur__["a" /* default */], '\n')
...
let test = __WEBPACK_IMPORTED_MODULE_1_moment_recur___default()(__WEBPACK_IMPORTED_MODULE_0_moment___default.a).recur().every(1).days()
let v = Object(__WEBPACK_IMPORTED_MODULE_2__utils__["a" /* add */])(2,3)
